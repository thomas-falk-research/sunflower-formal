...
**Status: 2026-09-20T20:20Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1285 -> 1286 rows)
...
- **1286 rows; 1117 labels decided; 1117 UNSAT; 0 SAT; 0 labels
  ...
  A row count is not a decision count: 1117 decided plus 169 superseded
...
- **Frontier contiguous 0..1110, highest decided 1118, holes [1111, 1112].**
  <!-- SPAN-STATE: open -->
...
- **1117 of 1949 = 57.3114%**; **832 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 9]` idx 1095..1115: **21 members**,
  **19 decided**, undecided [1111, 1112]
- `[13, 13, 10, 8]` idx 1116..1130: **15 members**,
  **3 decided**, undecided 12 spanning 1119..1130
