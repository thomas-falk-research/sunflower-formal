...
**Status: 2026-09-20T14:47Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1271 -> 1272 rows)
...
- **1272 rows; 1103 labels decided; 1103 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 through #44.
  A row count is not a decision count: 1103 decided plus 169 superseded
...
- **Frontier contiguous 0..1102, highest decided 1102, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1103 of 1949 = 56.5931%**; **846 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 9]` idx 1095..1115: **21 members**,
  **8 decided**, undecided 13 spanning 1103..1115
