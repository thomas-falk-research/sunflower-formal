...
**Status: 2026-09-20T12:46Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1262 -> 1263 rows)
...
- **1263 rows; 1094 labels decided; 1094 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 through #44.
  A row count is not a decision count: 1094 decided plus 169 superseded
...
- **Frontier contiguous 0..1087, highest decided 1095, holes [1088, 1092].**
  <!-- SPAN-STATE: open -->
...
- **1094 of 1949 = 56.1313%**; **855 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 10]` idx 1067..1094: **28 members**,
  **26 decided**, undecided [1088, 1092]
