...
**Status: 2026-09-20T22:43Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1294 -> 1295 rows)
...
- **1295 rows; 1126 labels decided; 1126 UNSAT; 0 SAT; 0 labels
  ...
  A row count is not a decision count: 1126 decided plus 169 superseded
...
- **Frontier contiguous 0..1124, highest decided 1127, holes [1125, 1126].**
  <!-- SPAN-STATE: open -->
...
- **1126 of 1949 = 57.7732%**; **823 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 8]` idx 1116..1130: **15 members**,
  **10 decided**, undecided [1125, 1126, 1128, 1129, 1130]
