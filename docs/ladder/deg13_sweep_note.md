...
**Status: 2026-09-21T00:30Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1304 -> 1305 rows)
...
- **1305 rows; 1136 labels decided; 1136 UNSAT; 0 SAT; 0 labels
  ...
  A row count is not a decision count: 1136 decided plus 169 superseded
...
- **Frontier contiguous 0..1134, highest decided 1137, holes [1135, 1136].**
  <!-- SPAN-STATE: open -->
  **A SPAN IS OPEN, AND IT IS THE FORTY-THIRD.** idx 1137 landed at
  2646.0 s while **1135 and 1136** were still running — an opening at
  **two holes**. The frontier and hole set are on the bullet line above,
  which bank.py owns; *this prose deliberately does not repeat them.*
  **No duration, no rank, no monotonicity and no commit count until it
  closes.**
...
- **1136 of 1949 = 58.2863%**; **813 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 7]` idx 1131..1141: **11 members**,
  **5 decided**, undecided 6 spanning 1135..1141
