...
**Status: 2026-09-17T22:25Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1012 -> 1013 rows)

- **1013 rows; 844 labels decided; 844 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 or #38. A row
  count is not a decision count: 844 decided plus 169 superseded UNKNOWN
...
- **Driver is pid 27205**, launched 2026-09-17T18:48:13.310000Z (read from
  ...
  from this line.
- **Frontier contiguous 0..837, highest decided 844, holes [838].**
...
- **844 of 1949 = 43.3043%**; **1105 undecided**. **43% IS CROSSED**, at
...
- Block census: `[13,13,12,12]` closed 82/82; `[13,13,12,11]` closed 65/65;
  ...
  members, contiguity verified, 3 decided**. When either closes, record its
