...
**Status: 2026-09-20T09:26Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1248 -> 1249 rows)
...
- **1249 rows; 1080 labels decided; 1080 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 through #44.
  A row count is not a decision count: 1080 decided plus 169 superseded
...
- **Frontier contiguous 0..1079, highest decided 1079, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1080 of 1949 = 55.4130%**; **869 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 10]` idx 1067..1094: **28 members**,
  **13 decided**, undecided 15 spanning 1080..1094
