...
**Status: 2026-09-20T10:32Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1251 -> 1252 rows)
...
- **1252 rows; 1083 labels decided; 1083 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 through #44.
  A row count is not a decision count: 1083 decided plus 169 superseded
...
- **Frontier contiguous 0..1082, highest decided 1082, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1083 of 1949 = 55.5670%**; **866 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 10]` idx 1067..1094: **28 members**,
  **16 decided**, undecided 12 spanning 1083..1094
