...
the frontier top without changing them; and 812 filled at 14:17:43Z, leaving
**one** — 814. No duration, rank or monotonicity until it fills.
...
## State as of the last refresh (984 -> 985 rows)

- **985 rows; 816 labels decided; 816 UNSAT; 0 SAT; 0 labels
...
- **Driver is pid 22176**, launched 2026-09-17T05:52:11.890000Z (read from
  ...
  from this line.
- **Frontier contiguous 0..813, highest decided 816, holes [814].**
  A ninth span is OPEN.
- **816 of 1949 = 41.8676%**; **1133 undecided**. 41% was crossed at idx 800,
  checked and not rounded: 799/1949 = 40.9954% rounds to 41.0 and is NOT
  above 41; 800/1949 = 41.0467% is. Next: 42% needs
  `ceil(0.42 × 1949) = 819` — 3 more. **A rounded milestone is not a
...
- Block census: `[13,13,12,12]` closed 82/82; `[13,13,12,11]` closed 65/65;
  ...
  verified, 23 decided.** When it closes, record its descriptive stats as
