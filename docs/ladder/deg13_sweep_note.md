...
**Status: 2026-09-18T04:09Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1061 -> 1062 rows)

- **1062 rows; 893 labels decided; 893 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 or #38. A row
  count is not a decision count: 893 decided plus 169 superseded UNKNOWN
...
- **Driver is pid 27205**, launched 2026-09-17T18:48:13.310000Z (read from
  ...
  from this line.
- **Frontier contiguous 0..892, highest decided 892, holes [].**
...
- **893 of 1949 = 45.8184%**; **1056 undecided**. **45% IS CROSSED**, at
...
- Block census: `[13,13,12,12]` closed 82/82; `[13,13,12,11]` closed 65/65;
  ...
  **`[13,13,12,7]` is now CLOSED 21/21** (idx 821..841, contiguity
  ...
  886..934, **49 members**, contiguity verified, **7 decided** — the upward
