...
**Status: 2026-09-20T13:06Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1263 -> 1264 rows)
...
- **1264 rows; 1095 labels decided; 1095 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 through #44.
  A row count is not a decision count: 1095 decided plus 169 superseded
...
- **Frontier contiguous 0..1087, highest decided 1095, holes [1088].**
  <!-- SPAN-STATE: open -->
...
- **1095 of 1949 = 56.1827%**; **854 undecided**. **50% IS CROSSED**, at
