...
**Status: 2026-09-20T23:37Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1300 -> 1301 rows)
...
- **1301 rows; 1132 labels decided; 1132 UNSAT; 0 SAT; 0 labels
  ...
  A row count is not a decision count: 1132 decided plus 169 superseded
...
- **Frontier contiguous 0..1127, highest decided 1132, holes [1128].**
  <!-- SPAN-STATE: open -->
...
- **1132 of 1949 = 58.0811%**; **817 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 7]` idx 1131..1141: **11 members**,
  **2 decided**, undecided 9 spanning 1133..1141
