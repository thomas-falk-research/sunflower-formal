...
**Status: 2026-09-22T19:05Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1534 -> 1535 rows)
...
- **1535 rows; 1366 labels decided; 1366 UNSAT; 0 SAT; 0 labels
  ...
  this time.
  A row count is not a decision count: 1366 decided plus 169 superseded
...
- **Frontier contiguous 0..1365, highest decided 1365, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1366 of 1949 = 70.0872%**; **583 undecided**. **50% IS CROSSED**, at
...
- `[13, 12, 12, 10]` idx 1348..1385: **38 members**,
  **18 decided**, undecided 20 spanning 1366..1385
