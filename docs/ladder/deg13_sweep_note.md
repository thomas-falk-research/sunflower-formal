...
**Status: 2026-09-21T01:26Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1310 -> 1311 rows)
...
- **1311 rows; 1142 labels decided; 1142 UNSAT; 0 SAT; 0 labels
  ...
  A row count is not a decision count: 1142 decided plus 169 superseded
...
- **Frontier contiguous 0..1137, highest decided 1143, holes [1138, 1139].**
  <!-- SPAN-STATE: open -->
...
- **1142 of 1949 = 58.5942%**; **807 undecided**. **50% IS CROSSED**, at
