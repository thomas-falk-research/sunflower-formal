...
**Status: 2026-09-20T14:32Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1270 -> 1271 rows)
...
- **1271 rows; 1102 labels decided; 1102 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 through #44.
  A row count is not a decision count: 1102 decided plus 169 superseded
...
- **Frontier contiguous 0..1101, highest decided 1101, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1102 of 1949 = 56.5418%**; **847 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 9]` idx 1095..1115: **21 members**,
  **7 decided**, undecided 14 spanning 1102..1115
