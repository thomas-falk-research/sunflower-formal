...
**Status: 2026-09-20T19:48Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1283 -> 1284 rows)
...
- **1284 rows; 1115 labels decided; 1115 UNSAT; 0 SAT; 0 labels
  ...
  A row count is not a decision count: 1115 decided plus 169 superseded
...
- **Frontier contiguous 0..1110, highest decided 1116, holes [1111, 1112].**
  <!-- SPAN-STATE: open -->
...
- **1115 of 1949 = 57.2088%**; **834 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 8]` idx 1116..1130: **15 members**,
  **1 decided**, undecided 14 spanning 1117..1130
