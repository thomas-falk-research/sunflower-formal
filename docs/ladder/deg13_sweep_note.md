...
**Status: 2026-09-21T14:40Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1425 -> 1426 rows)
...
- **1426 rows; 1257 labels decided; 1257 UNSAT; 0 SAT; 0 labels
  ...
  this time.
  A row count is not a decision count: 1257 decided plus 169 superseded
...
- **Frontier contiguous 0..1256, highest decided 1256, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1257 of 1949 = 64.4946%**; **692 undecided**. **50% IS CROSSED**, at
...
- `[13, 12, 12, 12]` idx 1234..1298: **65 members**,
  **23 decided**, undecided 42 spanning 1257..1298
