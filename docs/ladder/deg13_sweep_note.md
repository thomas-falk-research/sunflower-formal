...
**Status: 2026-09-18T15:49Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1100 -> 1101 rows)

- **1101 rows; 932 labels decided; 932 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37, #38 or #39. A row
  count is not a decision count: 932 decided plus 169 superseded UNKNOWN
...
- **Driver is pid 22266**, launched 2026-09-18T07:45:20.720000Z (read from
  ...
  from this line.
- **Frontier contiguous 0..927, highest decided 932, holes [928].**
  **THE EIGHTEENTH SPAN IS OPEN**, and it opened with **three holes at
  ...
  this span closes.
- **932 of 1949 = 47.8194%**; **1017 undecided**. **47% IS CROSSED**, at
...
- Block census: `[13,13,12,12]` closed 82/82; `[13,13,12,11]` closed 65/65;
  ...
  **`[13,13,12,7]` is now CLOSED 21/21** (idx 821..841, contiguity
  ...
  886..934, **49 members**, contiguity verified, **46 decided** — the upward
