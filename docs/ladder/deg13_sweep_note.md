...
**Status: 2026-09-18T16:29Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1105 -> 1106 rows)

- **1106 rows; 937 labels decided; 937 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37, #38 or #39. A row
  count is not a decision count: 937 decided plus 169 superseded UNKNOWN
...
- **Driver is pid 22266**, launched 2026-09-18T07:45:20.720000Z (read from
  ...
  from this line.
- **Frontier contiguous 0..936, highest decided 936, holes [].**
  **No span is open.** The eighteenth closed at `faa424a`, filled by idx
  ...
  current 83.
- **937 of 1949 = 48.0759%**; **1012 undecided**. **48% IS CROSSED**, at
...
- `[13, 13, 11, 10]` idx 935..972: **38 members**,
  **2 decided**, undecided 36 spanning 937..972
