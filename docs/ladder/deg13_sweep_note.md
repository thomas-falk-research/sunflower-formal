...
**Status: 2026-09-20T13:19Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1265 -> 1266 rows)
...
- **1266 rows; 1097 labels decided; 1097 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 through #44.
  A row count is not a decision count: 1097 decided plus 169 superseded
...
- **Frontier contiguous 0..1096, highest decided 1096, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1097 of 1949 = 56.2853%**; **852 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 9]` idx 1095..1115: **21 members**,
  **2 decided**, undecided 19 spanning 1097..1115
