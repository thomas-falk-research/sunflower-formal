...
**Status: 2026-09-20T12:45Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1261 -> 1262 rows)
...
- **1262 rows; 1093 labels decided; 1093 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 through #44.
  A row count is not a decision count: 1093 decided plus 169 superseded
...
- **Frontier contiguous 0..1087, highest decided 1094, holes [1088, 1092].**
  <!-- SPAN-STATE: open -->
...
- **1093 of 1949 = 56.0800%**; **856 undecided**. **50% IS CROSSED**, at
