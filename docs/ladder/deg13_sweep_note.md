...
**Status: 2026-09-18T13:15Z.** Re-verify with `checkpoint_audit.py`; the
...
holes at once 2 at `9e6e8e1` `[911, 912]`. By duration it ranks **28 of
81** with 27 longer and no ties; by commit count **45 of 81**, with 18
tied at 2 and 44 carrying more. Read through the distribution: **24 of 81
ran longer than an hour** and **37 of 81 longer than a second**, so rank
28 of 81 is rank 28 of the 37 that lasted at all. **No restart was
involved** — unlike the fifteenth, this span opened on ordinary completion
order.
...
**Sixteen** spans, and the verdict tally needs its COMPARISON COUNTS
...
**Nine True of sixteen** — and the breakdown is where the weight goes.
...
than one** (span 4 with two, span 6 with four). The partition is produced
...
## State as of the last refresh (1089 -> 1090 rows)

- **1090 rows; 921 labels decided; 921 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37, #38 or #39. A row
  count is not a decision count: 921 decided plus 169 superseded UNKNOWN
...
- **Driver is pid 22266**, launched 2026-09-18T07:45:20.720000Z (read from
  ...
  from this line.
- **Frontier contiguous 0..917, highest decided 922, holes [918, 921].**
...
- **921 of 1949 = 47.2550%**; **1028 undecided**. **47% IS CROSSED**, at
...
- Block census: `[13,13,12,12]` closed 82/82; `[13,13,12,11]` closed 65/65;
  ...
  **`[13,13,12,7]` is now CLOSED 21/21** (idx 821..841, contiguity
  ...
  886..934, **49 members**, contiguity verified, **35 decided** — the upward
