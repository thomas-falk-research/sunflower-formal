...
**Status: 2026-09-20T13:17Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1264 -> 1265 rows)
...
- **1265 rows; 1096 labels decided; 1096 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 through #44.
  A row count is not a decision count: 1096 decided plus 169 superseded
...
- **Frontier contiguous 0..1095, highest decided 1095, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1096 of 1949 = 56.2340%**; **853 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 9]` idx 1095..1115: **21 members**,
  **1 decided**, undecided 20 spanning 1096..1115
