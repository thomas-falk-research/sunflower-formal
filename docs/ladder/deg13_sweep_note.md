...
**Status: 2026-09-21T05:09Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1341 -> 1342 rows)
...
- **1342 rows; 1173 labels decided; 1173 UNSAT; 0 SAT; 0 labels
  ...
  A row count is not a decision count: 1173 decided plus 169 superseded
...
- **Frontier contiguous 0..1169, highest decided 1175, holes [1170, 1171, 1173].**
  <!-- SPAN-STATE: open -->
...
- **1173 of 1949 = 60.1847%**; **776 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 9, 9]` idx 1161..1175: **15 members**,
  **12 decided**, undecided [1170, 1171, 1173]
