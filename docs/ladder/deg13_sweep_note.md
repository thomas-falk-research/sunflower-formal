...
**Status: 2026-09-18T17:43Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1110 -> 1111 rows)

- **1111 rows; 942 labels decided; 942 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37, #38 or #39. A row
  count is not a decision count: 942 decided plus 169 superseded UNKNOWN
...
- **Driver is pid 22266**, launched 2026-09-18T07:45:20.720000Z (read from
  ...
  from this line.
- **Frontier contiguous 0..941, highest decided 941, holes [].**
  **No span is open.** The eighteenth closed at `faa424a`, filled by idx
  ...
  current 83.
- **942 of 1949 = 48.3325%**; **1007 undecided**. **48% IS CROSSED**, at
...
- `[13, 13, 11, 10]` idx 935..972: **38 members**,
  **7 decided**, undecided 31 spanning 942..972
