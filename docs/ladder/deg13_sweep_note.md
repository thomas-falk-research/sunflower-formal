...
**Status: 2026-09-22T19:55Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1537 -> 1538 rows)
...
- **1538 rows; 1369 labels decided; 1369 UNSAT; 0 SAT; 0 labels
  ...
  this time.
  A row count is not a decision count: 1369 decided plus 169 superseded
...
- **Frontier contiguous 0..1366, highest decided 1369, holes [1367].**
  <!-- SPAN-STATE: open -->
...
- **1369 of 1949 = 70.2411%**; **580 undecided**. **50% IS CROSSED**, at
...
- `[13, 12, 12, 10]` idx 1348..1385: **38 members**,
  **21 decided**, undecided 17 spanning 1367..1385
