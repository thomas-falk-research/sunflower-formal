...
**Status: 2026-09-20T01:41Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1196 -> 1197 rows)
...
- **1197 rows; 1028 labels decided; 1028 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 through #43.
  A row count is not a decision count: 1028 decided plus 169 superseded
...
- **Frontier contiguous 0..1027, highest decided 1027, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1028 of 1949 = 52.7450%**; **921 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 11, 7]` idx 1022..1036: **15 members**,
  **6 decided**, undecided 9 spanning 1028..1036
