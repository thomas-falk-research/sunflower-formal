...
**Status: 2026-09-22T14:16Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1510 -> 1511 rows)
...
- **1511 rows; 1342 labels decided; 1342 UNSAT; 0 SAT; 0 labels
  ...
  this time.
  A row count is not a decision count: 1342 decided plus 169 superseded
...
- **Frontier contiguous 0..1339, highest decided 1343, holes [1340, 1341].**
  <!-- SPAN-STATE: open -->
...
- **1342 of 1949 = 68.8558%**; **607 undecided**. **50% IS CROSSED**, at
...
- `[13, 12, 12, 11]` idx 1299..1347: **49 members**,
  **43 decided**, undecided 6 spanning 1340..1347
