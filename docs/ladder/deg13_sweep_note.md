...
**Status: 2026-09-20T20:21Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1286 -> 1287 rows)
...
- **1287 rows; 1118 labels decided; 1118 UNSAT; 0 SAT; 0 labels
  ...
  A row count is not a decision count: 1118 decided plus 169 superseded
...
- **Frontier contiguous 0..1111, highest decided 1118, holes [1112].**
  <!-- SPAN-STATE: open -->
...
- **1118 of 1949 = 57.3628%**; **831 undecided**. **50% IS CROSSED**, at
