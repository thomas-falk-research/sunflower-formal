...
**Status: 2026-09-22T14:02Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1507 -> 1508 rows)
...
- **1508 rows; 1339 labels decided; 1339 UNSAT; 0 SAT; 0 labels
  ...
  this time.
  A row count is not a decision count: 1339 decided plus 169 superseded
...
- **Frontier contiguous 0..1338, highest decided 1338, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1339 of 1949 = 68.7019%**; **610 undecided**. **50% IS CROSSED**, at
...
- `[13, 12, 12, 11]` idx 1299..1347: **49 members**,
  **40 decided**, undecided 9 spanning 1339..1347
