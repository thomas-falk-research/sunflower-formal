...
**Status: 2026-09-21T23:47Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1461 -> 1462 rows)
...
- **1462 rows; 1293 labels decided; 1293 UNSAT; 0 SAT; 0 labels
  ...
  this time.
  A row count is not a decision count: 1293 decided plus 169 superseded
...
- **Frontier contiguous 0..1288, highest decided 1293, holes [1289].**
  <!-- SPAN-STATE: open -->
...
- **1293 of 1949 = 66.3417%**; **656 undecided**. **50% IS CROSSED**, at
...
- `[13, 12, 12, 12]` idx 1234..1298: **65 members**,
  **59 decided**, undecided 6 spanning 1289..1298
