...
**Status: 2026-09-22T16:11Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1523 -> 1524 rows)
...
- **1524 rows; 1355 labels decided; 1355 UNSAT; 0 SAT; 0 labels
  ...
  this time.
  A row count is not a decision count: 1355 decided plus 169 superseded
...
- **Frontier contiguous 0..1354, highest decided 1354, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1355 of 1949 = 69.5228%**; **594 undecided**. **50% IS CROSSED**, at
...
- `[13, 12, 12, 10]` idx 1348..1385: **38 members**,
  **7 decided**, undecided 31 spanning 1355..1385
