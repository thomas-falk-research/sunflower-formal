...
**Status: 2026-09-18T12:41Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1087 -> 1088 rows)

- **1088 rows; 919 labels decided; 919 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37, #38 or #39. A row
  count is not a decision count: 919 decided plus 169 superseded UNKNOWN
...
- **Driver is pid 22266**, launched 2026-09-18T07:45:20.720000Z (read from
  ...
  from this line.
- **Frontier contiguous 0..917, highest decided 919, holes [918].**
...
- **919 of 1949 = 47.1524%**; **1030 undecided**. **47% IS CROSSED**, at
...
- Block census: `[13,13,12,12]` closed 82/82; `[13,13,12,11]` closed 65/65;
  ...
  **`[13,13,12,7]` is now CLOSED 21/21** (idx 821..841, contiguity
  ...
  886..934, **49 members**, contiguity verified, **33 decided** — the upward
