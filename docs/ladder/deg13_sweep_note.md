...
**Status: 2026-09-20T05:47Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1215 -> 1216 rows)
...
- **1216 rows; 1047 labels decided; 1047 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37 through #44.
  A row count is not a decision count: 1047 decided plus 169 superseded
...
- **Frontier contiguous 0..1043, highest decided 1048, holes [1044, 1045].**
  <!-- SPAN-STATE: open -->
...
- **1047 of 1949 = 53.7199%**; **902 undecided**. **50% IS CROSSED**, at
