...
**Status: 2026-09-21T01:21Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1309 -> 1310 rows)
...
- **1310 rows; 1141 labels decided; 1141 UNSAT; 0 SAT; 0 labels
  ...
  A row count is not a decision count: 1141 decided plus 169 superseded
...
- **Frontier contiguous 0..1137, highest decided 1142, holes [1138, 1139].**
  <!-- SPAN-STATE: open -->
...
- **1141 of 1949 = 58.5428%**; **808 undecided**. **50% IS CROSSED**, at
