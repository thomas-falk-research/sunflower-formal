...
**Status: 2026-09-18T18:18Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1113 -> 1114 rows)

- **1114 rows; 945 labels decided; 945 UNSAT; 0 SAT; 0 labels
  undecided-only.** No rows were lost across restarts #37, #38 or #39. A row
  count is not a decision count: 945 decided plus 169 superseded UNKNOWN
...
- **Driver is pid 22266**, launched 2026-09-18T07:45:20.720000Z (read from
  ...
  from this line.
- **Frontier contiguous 0..944, highest decided 944, holes [].**
  **No span is open.** The eighteenth closed at `faa424a`, filled by idx
  ...
  current 83.
- **945 of 1949 = 48.4864%**; **1004 undecided**. **48% IS CROSSED**, at
...
- `[13, 13, 11, 10]` idx 935..972: **38 members**,
  **10 decided**, undecided 28 spanning 945..972
