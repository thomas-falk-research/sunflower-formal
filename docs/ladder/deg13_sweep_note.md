...
**Status: 2026-09-20T19:56Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1284 -> 1285 rows)
...
- **1285 rows; 1116 labels decided; 1116 UNSAT; 0 SAT; 0 labels
  ...
  A row count is not a decision count: 1116 decided plus 169 superseded
...
- **Frontier contiguous 0..1110, highest decided 1117, holes [1111, 1112].**
  <!-- SPAN-STATE: open -->
...
- **1116 of 1949 = 57.2601%**; **833 undecided**. **50% IS CROSSED**, at
...
- `[13, 13, 10, 8]` idx 1116..1130: **15 members**,
  **2 decided**, undecided 13 spanning 1118..1130
