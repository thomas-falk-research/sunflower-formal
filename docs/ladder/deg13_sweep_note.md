...
**Status: 2026-09-22T16:34Z.** Re-verify with `checkpoint_audit.py`; the
...
## State as of the last refresh (1526 -> 1527 rows)
...
- **1527 rows; 1358 labels decided; 1358 UNSAT; 0 SAT; 0 labels
  ...
  this time.
  A row count is not a decision count: 1358 decided plus 169 superseded
...
- **Frontier contiguous 0..1357, highest decided 1357, holes [].**
  <!-- SPAN-STATE: closed -->
...
- **1358 of 1949 = 69.6768%**; **591 undecided**. **50% IS CROSSED**, at
...
- `[13, 12, 12, 10]` idx 1348..1385: **38 members**,
  **10 decided**, undecided 28 spanning 1358..1385
