...
for every theorem in the "Closed" table (400 of them). The current
...
Current mutation results: 79 mutations, all matching the outcome
declared in `tools/mutations.toml` — 76 killed outright, two genuine
