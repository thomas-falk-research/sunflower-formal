...
for every theorem in the "Closed" table (510 of them). The current
...
Current mutation results: 117 mutations, all matching the outcome
declared in `tools/mutations.toml` — 114 killed outright, two genuine
