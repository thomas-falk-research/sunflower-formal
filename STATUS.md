...
for every theorem in the "Closed" table (733 of them). The current
...
Current mutation results: 162 mutations, all matching the outcome
declared in `tools/mutations.toml` — 160 killed outright, two genuine
