...
for every theorem in the "Closed" table (501 of them). The current
...
Current mutation results: 114 mutations, all matching the outcome
declared in `tools/mutations.toml` — 111 killed outright, two genuine
