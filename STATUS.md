...
for every theorem in the "Closed" table (491 of them). The current
...
Current mutation results: 110 mutations, all matching the outcome
declared in `tools/mutations.toml` — 107 killed outright, two genuine
