...
for every theorem in the "Closed" table (487 of them). The current
...
Current mutation results: 109 mutations, all matching the outcome
declared in `tools/mutations.toml` — 106 killed outright, two genuine
