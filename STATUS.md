...
for every theorem in the "Closed" table (481 of them). The current
...
Current mutation results: 106 mutations, all matching the outcome
declared in `tools/mutations.toml` — 103 killed outright, two genuine
