...
for every theorem in the "Closed" table (343 of them). The current
...
Current mutation results: 68 mutations, all matching the outcome
declared in `tools/mutations.toml` — 65 killed outright, two genuine
