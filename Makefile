COQFILES := coq/Sets.v coq/Sunflower.v coq/Graph.v coq/Matching.v \
            ...
            coq/Spread.v coq/Conjecture.v coq/SmallCases.v coq/F23.v

.PHONY: all coq verify rust test clean print-assumptions
...
verify: clean coq print-assumptions
	@echo
...
print-assumptions: coq
	...
	@for thm in \
	    ...
	    'Sunflower.sunflower_lift' ; do \
	  result=$$(printf 'From Sunflower Require Import ErdosRado ErdosRado_Greedy LowerBound ProductLowerBound F23 SmallCases Pigeonhole Sunflower HallCore KoenigHall.\nPrint Assumptions %s.\n' "$$thm" \
