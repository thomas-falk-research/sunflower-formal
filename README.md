...
- **Testing what the kernel cannot check.** Both errors this
  ...
  that something breaks. Of 131 mutations, 128 are killed outright, two
...
```bash
make verify        # builds all 43 Coq files, then runs the axiom audit
```

Expected: every audited theorem (568 of them, including `f_2_3_eq_7`,
