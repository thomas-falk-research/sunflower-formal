...
- **Testing what the kernel cannot check.** Both errors this
  ...
  that something breaks. Of 85 mutations, 82 are killed outright, two
...
```bash
make verify        # builds all 38 Coq files, then runs the axiom audit
```

Expected: every audited theorem (416 of them, including `f_2_3_eq_7`,
