...
- **Testing what the kernel cannot check.** Both errors this
  ...
  that something breaks. Of 114 mutations, 111 are killed outright, two
...
```bash
make verify        # builds all 41 Coq files, then runs the axiom audit
```

Expected: every audited theorem (501 of them, including `f_2_3_eq_7`,
