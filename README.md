...
- **Testing what the kernel cannot check.** Both errors this
  ...
  that something breaks. Of 137 mutations, 134 are killed outright, two
...
```bash
make verify        # builds all 44 Coq files, then runs the axiom audit
```

Expected: every audited theorem (592 of them, including `f_2_3_eq_7`,
