...
- **Testing what the kernel cannot check.** Both errors this
  ...
  that something breaks. Of 157 mutations, 154 are killed outright, two
...
```bash
make verify        # builds all 48 Coq files, then runs the axiom audit
```

Expected: every audited theorem (723 of them, including `f_2_3_eq_7`,
