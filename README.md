...
- **Testing what the kernel cannot check.** Both errors this
  ...
  that something breaks. Of 78 mutations, 75 are killed outright, two
...
```bash
make verify        # builds all 36 Coq files, then runs the axiom audit
```

Expected: every audited theorem (397 of them, including `f_2_3_eq_7`,
